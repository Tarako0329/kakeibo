			...
			<div class='row'>
				...
				<form action='login_sql.php' method="POST">
					...
					<div class='row' style='margin-top:10px;'>
						<div class='col-6 text-center'><button type='submit' class='btn btn-primary btn-lg' name='login' value='login'>ログイン</button></div>
						<div class='col-6 text-center'><button type='submit' class='btn btn-primary btn-lg' name='login' value='newlogin'>新規登録</button></div>
					</div>
				</form>
			</div>
		</MAIN>
